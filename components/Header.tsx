        ...
        >
          <div className="px-4 py-5 space-y-4 shadow-inner">
            ...
            <div className="flex flex-wrap items-center justify-between w-full gap-3 py-4 mt-2 border-t border-cyan-600">
              ...
              {!auth ? (
                <button 
                  className="w-full bg-[#0F0448] hover:bg-[#2a1e7c] text-white font-medium py-2 px-4 rounded-md shadow transition-all duration-200 flex items-center justify-center"
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 ml-auto">
              ...
              {!auth ? (
                <button 
                  className="bg-[#0F0448] hover:bg-[#2a1e7c] text-white font-medium py-2 px-4 rounded-md shadow transition-all duration-200 flex items-center justify-center"
                  onClick={() => router.push('/register')}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
